            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-center">
                ...
                <p className="text-sm text-[#4B5563] leading-relaxed mb-3">
                  An AI-powered web app that analyzes waste materials, recommends upcycling and recycling pathways, and estimates carbon impact — each act recorded as part of the city&apos;s circular story.
                </p>
                <p className="text-sm text-[#4B5563] leading-relaxed mb-3">
                  Every waste entry can be geolocated and documented, building a growing map of Rome&apos;s material flows — what was found, what could be remade, and what was saved from landfill.
                </p>
                <p className="text-sm text-[#4B5563] leading-relaxed mb-4">
                  From detection to Digital Deed, REvision turns every piece of waste into a data point for a cleaner city.
                </p>
          ...
          <div className="project-feature bg-[#F0FFF4] rounded-xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-center">
                ...
                <p className="text-sm text-[#4B5563] leading-relaxed mb-3">
                  <strong>15–20%</strong> of generated energy will light the surrounding neighborhood. Powers <strong>EV charging stations</strong> and <strong>RE Lab workshops</strong> for the local community.
                </p>
                <p className="text-sm text-[#4B5563] leading-relaxed mb-4">
                  Hosts all recycling and upcycling art projects. Inspired by the Pantheon — a circular energy and culture hub for Rome.
                </p>
          ...
          <div className="project-feature bg-[#F0FFF4] rounded-xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-center">
                ...
                <p className="text-sm text-[#4B5563] leading-relaxed mb-3">
                  Discarded ATAC bus tires become a <strong>climbing wall and play area</strong>. A landmark waste-to-art public installation.
                </p>
                <p className="text-sm text-[#4B5563] leading-relaxed mb-4">
                  <strong>RO Guiltless Plastic: Urban and Public Design Category — Mention Prize Winner.</strong> Every tire tracked from collection to installation.
                </p>
